    ...
    <div class="container py-5 px-3 px-md-4">
                        ...
                        <tbody>
                            @foreach ($hasil as $row)
                                <tr>
                                    ...
                                    <td class="text-center py-3">
                                        <span
                                            class="badge bg-info text-white fs-6 px-3 py-2">{{ $row['nilai_total'] }}%</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="card mt-3 border-0 bg-light shadow-sm">
            <div class="card-body py-2">
                <small class="text-muted"><i class="bi bi-info-circle me-1"></i><strong>Skala:</strong> 1 = Tidak Baik, 2 =
                    Kurang Baik, 3 = Cukup, 4 = Baik, 5 = Sangat Baik</small>
            </div>
        </div>
    </div>
