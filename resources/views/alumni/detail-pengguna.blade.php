                ...
                <div class="content py-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('tracer.kuesioner-pengguna.edit', $pengguna->id) }}" class="btn btn-primary">
                                Edit
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <p class="mb-0 fw-medium">{{ $pengguna->nama ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label class="form-label text-muted small">Program Studi</label>
                                                <p class="mb-0 fw-medium">{{ $pengguna->prodi ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label class="form-label text-muted small">Alamat</label>
                                                <p class="mb-0 fw-medium">{{ $pengguna->alamat ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-0">
                                                <label class="form-label text-muted small">Jabatan</label>
                                                <p class="mb-0 fw-medium">{{ $pengguna->jabatan ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <p class="mb-0 fw-medium">{{ $pengguna->nama_perusahaan ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label class="form-label text-muted small">Alamat Perusahaan</label>
                                                <p class="mb-0 fw-medium">{{ $pengguna->alamat_perusahaan ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label class="form-label text-muted small">Nama Atasan</label>
                                                <p class="mb-0 fw-medium">{{ $pengguna->nama_atasan ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="form-label text-muted small">NIP Atasan</label>
                                                <p class="mb-0 fw-medium">{{ $pengguna->nip_atasan ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-0">
                                                <label class="form-label text-muted small">Posisi Atasan</label>
                                                <p class="mb-0 fw-medium">{{ $pengguna->posisi_jabatan_atasan ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4">
                                        @php
                                            ...
                                            $kompetensiAll = [
                                                ...
                                                'Kemampuan Bahasa Inggris' => $pengguna->kemampuan,
                                ...
                                <div class="card-body py-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <small class="text-muted">
                                            Dibuat: {{ $pengguna->created_at->format('d F Y, H:i') }}
                                        </small>
                                        <small class="text-muted">
                                            Diperbarui: {{ $pengguna->updated_at->format('d F Y, H:i') }}
                                        </small>
                                    </div>
                                </div>
                            </div>
